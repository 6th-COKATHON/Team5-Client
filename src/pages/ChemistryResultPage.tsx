...
const ChemistryResultPage = () => {
  ...
  return (
    <div className='relative w-[540px] flex flex-col items-center px-4 py-10 overflow-hidden bg-[#FFE3F1]'>
      {/* 로고 */}
      ...
      {/* 박스 배경 + 콘텐츠 */}
      <div className='relative w-[418px] mb-[30px]'>
        {/* 배경 이미지 */}
        <BackgroundLayout className='absolute top-0 left-0 w-full h-full z-0' />

        {/* 콘텐츠 */}
        <div className='relative z-10 px-6 pt-8 pb-[40px] flex flex-col items-center text-center gap-5'>
          {/* 프로필 */}
          <ContentBox className='relative py-auto'>
